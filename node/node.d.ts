...
declare function clearInterval(intervalId: any): any;
declare function setImmediate(callback: () => void ): any;
declare function clearImmediate(immediateId: any): any;
...
declare module "cluster" {
    ...
    export function listeners(event: string): { Function: any; }[];
...
declare module "fs" {
    ...
    export function write(fd: string, buffer: NodeBuffer, offset: number, length: number, position: number, callback?: (err: any, written: number, buffer: NodeBuffer) =>any): void;
    export function writeSync(fd: string, buffer: NodeBuffer, offset: number, length: number, position: number): void;
    export function read(fd: string, buffer: NodeBuffer, offset: number, length: number, position: number, callback?: (err: any, bytesRead: number, buffer: NodeBuffer) => void): void;
    export function readSync(fd: string, buffer: NodeBuffer, offset: number, length: number, position: number): any[];
    export function readFile(filename: string, options: { encoding?: string; flag?: string; }, callback: (err: any, data: any) => void ): void;
    export function readFile(filename: string, callback: (err: any, data: NodeBuffer) => void ): void;
    ...
    export function writeFile(filename: string, data: any, options: { encoding?: string; mode?: number; flag?: string; }, callback?: (err: any) => void): void;
    export function writeFileSync(filename: string, data: any, options?: { encoding?: string; mode?: number; flag?: string; }): void;
    export function appendFile(filename: string, data: any, options: { encoding?: string; mode?: number; flag?: string; }, callback?: (err: any) => void): void;
    export function appendFile(filename: string, data: any, callback?: (err: any) => void): void;
...
declare module "crypto" {
    ...
    export function randomBytes(size: number, callback?: (err: Error, buf: NodeBuffer) =>void ): any;
}
